...
function openNexFiveCrystal(n){
    ...
    document.getElementById("showChamp").innerHTML = "<div class=\"framewithport\"><img class=\"border\" src=\""+cloudinary+"frame5.png\"><img class=\"head_image\" src=\""+cloudinary+nexchamp[0]+".png\"><div class=\"framewithport\"><img class=\"border\" src=\""+cloudinary+"frame5.png\"><img class=\"head_image\" src=\""+cloudinary+nexchamp[1]+".png\"><div class=\"framewithport\"><img class=\"border\" src=\""+cloudinary+"frame5.png\"><img class=\"head_image\" src=\""+cloudinary+nexchamp[2]+".png\"><br>-------------------"+document.getElementById("showChamp").innerHTML;
}
